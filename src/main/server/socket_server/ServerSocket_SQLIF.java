package main.server.socket_server;
...
import main.server.db_interface.DMLCommandExecutor;
import main.server.db_interface.DMLCommandExecutorSQLInjectionFree;
...
public class ServerSocket_SQLIF implements Runnable{
    ...
    public ServerSocket_SQLIF(Socket socket, SocketServer mainServer) {
        this.socket = socket;
    ...
    private void selectIntolerantsWorkersForMenuFromDbExecution() {
        ...
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectIntolerantsWorkersForMenuFromDb(codMenu);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
        //Send the list to main.client
        try {
    ...
    private void selectIntolerantsChildrenForMenuFromDbExecution() {
        ...
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectIntolerantsChildrenForMenuFromDb(codMenu);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectNotUntoleratedIngredientsForPersonFromDbExecution() {
        ...
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectNotUntoleratedIngredientsForPersonFromDb(p);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectUntoleratedIngredientsForPersonFromDbExecution() {
        ...
        List<String> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectUntoleratedIngredientsForPersonFromDb(p);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectIntolerantsWorkersForIngredientFromDbExecution() {
        ...
        List<Staff> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectIntolerantsWorkersForIngredientFromDb(nomeI);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectDishesForTypeFromDbExecution() {
        ...
        List<Dish> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectDishesForTypeFromDb(dishType);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void deleteDishFromMenuFromDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().deleteDishFromMenuFromDb(codMenu, nomeP);
    ...
    private void deleteIngredientFromDishFromDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().deleteIngredientFromDishFromDb(nomeP, nomeI);
    ...
    private void insertDishIntoMenuIntoDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertDishIntoMenuIntoDb(codMenu, nomeP);
    ...
    private void insertIngredientIntoDishIntoDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertIngredientIntoDishIntoDb(nomeP, nomeI);
    ...
    private void selectIngredientsForDishFromDbExecution() {
        ...
        List<String> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectIngredientsForDishFromDb(nomeP);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectDishesForMenuFromDbExecution() {
        ...
        List<Dish> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectDishesForMenuFromDb(codMenu);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectIntolerantsChildrenForIngredientFromDbExecution() {
        ...
        List<Child> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectIntolerantsChildrenForIngredientFromDb(nomeI);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectMenusFromDbExecution() {
        List<Menu> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectMenusFromDb();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        finally {
    ...
    private void selectDishesFromDbExecution() {
        List<Dish> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectDishesFromDb();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        finally {
    ...
    private void selectIngredientsFromDbExecution() {
        List<String> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectIngredientsFromDb();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        finally {
    ...
    private void deleteIntoleranceFromDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().deleteIntoleranceFromDb(intolerance);
    ...
    private void deleteDishFromDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().deleteDishFromDb(dish);
    ...
    private void insertIntoleranceIntoDbExecution() {
        try {
            Intolerance intolerance= (Intolerance)socketObjectIn.readObject();//Attesa bloccante
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertIntoleranceIntoDb(intolerance);
    ...
    private void insertDishIntoDbExecution() {
        try {
            Dish dish= (Dish)socketObjectIn.readObject();//Attesa bloccante
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertDishIntoDb(dish);
    ...
    private void insertIngredientIntoDbExecution() {
        try {
            String nomeI= (String)socketObjectIn.readObject();//Attesa bloccante
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertIngredientIntoDb(nomeI);
    ...
    private void selectChildrenForBusFromDbExecution() {
        ...
        List<Child> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectChildrenForBusFromDb(bus);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectMissingChildrenForStopFromDbExecution() {
        ...
        List<Child> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectMissingChildrenForStopFromDb(stop);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void insertPersonDailyPresenceIntoDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertPersonDailyPresenceIntoDb(codF);
    ...
    private void insertChildDailyPresenceIntoDbExecution() {
        try {
            String codF = (String)socketObjectIn.readObject();//Attesa bloccante
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertChildDailyPresenceIntoDb(codF);
    ...
    private void selectAvailableChildrenForTripExecution() {
        ...
        List<Child> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectAvailableChildrenForTripFromDb(tripDate);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void deleteBusAssociationFromDbExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().deleteBusAssociationFromDb(subscription);
            socketObjectOut.writeBoolean(status);
            socketObjectOut.flush();
    ...
    private void insertBusAssociationsIntoDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertTripSubscriptionsIntoDb(list);
    ...
    private void updateTripIntoDbExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().updateTripIntoDb(oldTrip, newTrip);
    ...
    private void updateBusIntoDbExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().updateBusIntoDb(oldBus, newBus);
    ...
    private void deleteStopPresenceFromDbExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().deleteStopPresenceFromDb(sp);
            socketObjectOut.writeBoolean(status);
            socketObjectOut.flush();
    ...
    private void deleteTripOrBusOrStopFromDbExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().deleteStopOrBusOrTripFromDb(subject, nomeG, dataG, numTappa, targa);
            socketObjectOut.writeBoolean(status);
            socketObjectOut.flush();
    ...
    private void insertStopPresencesIntoDbExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertStopPresencesIntoDb(list);
    ...
    private void insertNewStopIntoDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertNewStopIntoDb(stop);
    ...
    private void selectAllBusesForTripExecution() {
        ...
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectAllBusesForTripFromDb(nomeG, dataG);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectAllStopsForBusExecution() {
        ...
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectAllStopsFromBus(nomeG, dataG,targa);
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectAllTripsExecution() {
        ...
        List<Trip> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectAllTripsFromDb();
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void insertBusIntoDbExecution() {
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertBusIntoDb(bus);
    ...
    private void insertTripIntoDbExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertTripIntoDb(trip);
    ...
    private void selectParentsForChildExecution() {
        ...
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectParentsForChild(childCodF);
        } catch (SQLException e) {
            e.printStackTrace();
        }
        finally {
    ...
    private void deleteFromDbExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().deletePersonFromDb(subject, toDelId);
            socketObjectOut.writeBoolean(status);
            socketObjectOut.flush();
    ...
    private void selectAllChildrenExecution() {
        ...
        List<Child> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectChildrenFromDB();
        } catch (SQLException e) {
            e.printStackTrace();
            System.out.println(e.getSQLState());
        }
    ...
    private void selectAllSuppliersExecution() {
        ...
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectSuppliersFromDB();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        finally {
    ...
    private void selectAllStaffExecution() {
        List<Staff> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectStaffFromDB();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        finally {
    ...
    private void selectAllContactsExecution() {
        ...
        List<Contact> list = null;
        try {
            list = DMLCommandExecutorSQLInjectionFree.getInstance().selectContactsFromDB();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        finally {
    ...
    private void updatePersonExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().updatePersonIntoDb(p);
    ...
    private void updateSupplierExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().updateSupplierIntoDb(s);
    ...
    private void insertSupplierExecution() {
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertSupplierIntoDb(supplier);
    ...
    private void verifyLogin(){
        ...
        try {
            ...
            user = DMLCommandExecutorSQLInjectionFree.getInstance().selectUserForLogin(username, password);
    ...
    private void insertPersonExecution(){
        ...
        try {
            ...
            boolean status = DMLCommandExecutorSQLInjectionFree.getInstance().insertPersonIntoDb(p);
            socketObjectOut.writeBoolean(status);
            socketObjectOut.flush();
