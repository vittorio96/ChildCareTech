package main.client.server_interface;
...
import main.server.rmi_server.RemoteClientInterface;
...
//Adapter to reach the RMI Server while working in RMI mode. This class works on main.client side

public class RmiMode implements SessionMode {

    private RemoteServerInterface server; //Remote server object
    private RemoteClientInterface client; //Local main.client object

    public RmiMode(RemoteClientInterface client) {

        this.client = client; //Reference to the adaptee main.client
